...
@section('content')
    <header class="subheader">
        <h1>{!! trans('chronos::interface.Create image style') !!}</h1>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="panel">
                    ...
                    <image-style-editor inline-template>
                        {!! Form::open(['route' => 'api.settings.image_styles.store', 'method' => 'POST', 'v-on:submit.prevent' => 'saveForm', 'novalidate' => 'novalidate']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <table class="image-anchor table">
                                    <tbody>
                                    <tr class="odd">
                                        <td>
                                            <div class="radio">
