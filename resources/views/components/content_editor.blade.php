    ...
    <div class="fieldset" v-bind:class="{ minimized: isMinimized }">
        ...
        <div class="fieldset-repetition" v-for="(repetition, key) in repetitions">
            ...
            <div class="repetition-meta" v-if="repeatable">
                <span class="repetition-key" v-html="key + 1"></span><a class="delete-repetition" v-on:click="deleteRepetition(key)">{!! trans('chronos::forms.Remove repetition') !!}</a>
            </div>
        </div>
        <div class="fieldset-footer" v-if="repeatable">
            <a class="btn btn-action add-repetition" v-on:click="repeatFieldset">{!! trans('chronos::forms.Repeat fieldset') !!}</a>
        </div>
    </div>
</script>
