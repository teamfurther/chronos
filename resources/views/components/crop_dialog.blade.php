        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{!! trans('chronos::interface.Crop picture') !!}</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">{!! trans('chronos::interface.Close') !!}</button>
                    <button type="button" class="btn btn-primary" v-on:click="doUpload">{!! trans('chronos::forms.Crop and save') !!}</button>
                </div>
            </div>
        </div>
    </div>
