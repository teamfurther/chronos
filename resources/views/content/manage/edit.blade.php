                    ...
                    <div id="content-editor-wrapper">
                        ...
                        <div class="panel" v-show="!dataLoader">
                            ...
                            <div class="form-group" v-bind:class="{ 'has-error': Object.hasKey(store.formErrors, 'order') }">
                                <label class="control-label" for="status">{!! trans('chronos::forms.Order') !!}</label>
                ...
                <div class="col-xs-12 col-md-4">
                    <div class="content-sidebar" data-spy="affix" data-offset-top="100" v-show="!dataLoader">
                        @if (settings('is_multilanguage') && $type->translatable)
                            <div class="panel">
                                <h2 class="panel-title">{{ trans('chronos::interface.Languages') }}</h2>
                                <p class="paddingB15"><strong>{!! trans('chronos::interface.The language of this :type is <em>:language</em>.', ['type' => strtolower($type->name), 'language' => $content->languageName]) !!}</strong></p>
