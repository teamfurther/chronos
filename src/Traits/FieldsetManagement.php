...
trait FieldsetManagement
{
    ...
    private function validateFieldsetRequest($request)
    {
        ...
        $this->validate($request, [
            ...
            'fieldsets.*.fieldset_machine' => trans('chronos::forms.Fieldset machine name'),
            'fieldsets.*.name' => trans('chronos::forms.Fieldset name'),
            'fieldsets.*.fields.*.field_machine' => trans('chronos::forms.Field machine name'),
            'fieldsets.*.fields.*.name' => trans('chronos::forms.Field name'),
            'fieldsets.*.fields.*.entity_type' => trans('chronos::forms.Entity type'),
            'fieldsets.*.fields.*.step' => trans('chronos::forms.Step'),
            'fieldsets.*.fields.*.type' => trans('chronos::forms.Field type'),
            'fieldsets.*.fields.*.values' => trans('chronos::forms.Values'),
            'fieldsets.*.fields.*.widget' => trans('chronos::forms.Field widget'),
        ]);
    }
