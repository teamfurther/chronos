...
namespace Chronos\Api\Controllers\Users;
            ...
            return response()->json([
                'alerts' => [
                    (object) [
                        ...
                        'message' => trans('chronos::alerts.Role successfully deleted.'),
                    ]
                ],
                'status' => 200
            ], 200);
            ...
            return response()->json([
                'alerts' => [
                    (object) [
                        'type' => 'error',
                        'title' => trans('chronos::alerts.Error.'),
                        'message' => trans('chronos::alerts.Role deletion was unsuccessful.'),
                    ]
                ],
                'status' => 500
            ], 500);
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    'type' => 'success',
                    'title' => trans('chronos::alerts.Success.'),
                    'message' => trans('chronos::alerts.Role successfully created.'),
                ]
            ],
            'role' => $role,
            'status' => 200
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    'type' => 'success',
                    'title' => trans('chronos::alerts.Success.'),
                    'message' => trans('chronos::alerts.Permissions settings successfully saved.'),
                ]
            ],
            'role' => $role,
            'status' => 200
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    'type' => 'success',
                    'title' => trans('chronos::alerts.Success.'),
                    'message' => trans('chronos::alerts.Role successfully updated.'),
                ]
            ],
            'role' => $role,
            'status' => 200
