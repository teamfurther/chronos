...
use Chronos\Traits\ImageStyleManagement;
            ...
            return response()->json([
                'alerts' => [
                    (object) [
                        ...
                        'message' => trans('chronos::alerts.Image style deletion was successful.'),
                    ]
                ],
                'status' => 200
            ], 200);
            ...
            return response()->json([
                'alerts' => [
                    (object) [
                        'type' => 'error',
                        'title' => trans('chronos::alerts.Error.'),
                        'message' => trans('chronos::alerts.Image style deletion was unsuccessful.'),
                    ]
                ],
                'status' => 500
            ], 500);
            ...
            return response()->json([
                'alerts' => [
                    (object)[
                        'type' => 'success',
                        'title' => trans('chronos::alerts.Success.'),
                        'message' => trans_choice('chronos::alerts.:count images styles deleted.', $deleted_styles_count, ['count' => $deleted_styles_count])
                    ]
                ],
                'status' => 200
            ], 200);
            ...
            return response()->json([
                'alerts' => [
                    (object)[
                        ...
                        'message' => trans_choice('chronos::alerts.:count image styles deleted.', $deleted_styles_count, ['count' => $deleted_styles_count])
                    ]
                ],
                'status' => 200
            ], 200);
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    'type' => 'success',
                    'title' => trans('chronos::alerts.Success.'),
                    'message' => trans('chronos::alerts.Image style successfully created.'),
                ]
            ],
            'style' => $style,
            'status' => 200
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    'type' => 'success',
                    'title' => trans('chronos::alerts.Success.'),
                    'message' => trans('chronos::alerts.Image style successfully updated.'),
                ]
            ],
            'style' => $style,
            'status' => 200
