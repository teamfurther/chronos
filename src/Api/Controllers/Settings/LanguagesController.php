...
class LanguagesController extends Controller
{
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    ...
                    'message' => trans('chronos::alerts.Language successfully activated.'),
                ]
            ],
            'language' => $language,
            'status' => 200
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    'type' => 'success',
                    'title' => trans('chronos::alerts.Success.'),
                    'message' => trans('chronos::alerts.Language successfully deactivated.'),
                ]
            ],
            'language' => $language,
            'status' => 200
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'required' => trans('chronos::alerts.You must select a language.'),
            'unique' => trans('chronos::alerts.You have already added this language.')
        ]);
        ...
        return response()->json([
            'alerts' => [
                (object) [
                    'type' => 'success',
                    'title' => trans('chronos::alerts.Success.'),
                    'message' => trans('chronos::alerts.Language successfully added.'),
                ]
            ],
            'language' => $language,
            'status' => 200
