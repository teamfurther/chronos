...
class Media extends Model
{
    ...
    {
        return $this->belongsToMany('\Chronos\Models\Content', 'content_media', 'content_id', 'media_id');
    }
    ...
    {
        return $this->hasMany('\Chronos\Models\Media', 'parent_id');
    }
    ...
    {
        return $this->belongsTo('\Chronos\Models\Media');
    }
    ...
    {
        return $this->belongsTo('\Chronos\Models\ImageStyle', 'image_style_id');
    }
}
