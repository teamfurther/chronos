...
class Role extends Model {
    ...
    public function getEndpointsAttribute()
    {
        ...
        $endpoints['users'] = route('api.users.roles.users', ['role' => $id]);
        $endpoints['update'] = route('api.users.roles.update', ['role' => $id]);
        $endpoints['destroy'] = route('api.users.roles.destroy', ['role' => $id]);
